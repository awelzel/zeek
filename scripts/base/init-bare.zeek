...
## Zeek will update network_time to current wallclock time in order
## for timer expiration to function. A packet source queueing up packets
## and not yielding them for longer than this interval without yielding
...
## Whether Zeek will forward network_time to wallclock time upon
## observing an idle packet source (or no configured packet source).
##
## Only set this to T if you really know what you're doing. Setting this to
